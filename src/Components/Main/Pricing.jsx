...
const Pricing = () => {
    return (
        <div className='max-w-9/12 m-auto text-center'>
            ...
            <p className='text-lg font-light text-[#627382] mt-4'>Choose the plan that fits your needs. Upgrade or downgrade anytime.</p>
            ...
            <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-8 my-10'>
                <div className='flex flex-col items-start gap-4 border-2 border-gray-200 rounded-xl transition-all duration-[0.4s] hover:shadow-[0_20px_50px_rgba(148,68,251,0.2)] hover:-translate-y-2 p-6 relative'>
                    ...
                    <h5 className='flex items-center text-5xl font-extrabold'><FaDollarSign size={40} />0 <span className='text-lg'>/month</span></h5>
                    <ul>
                ...
                <div className='flex flex-col items-start gap-4 border-2 border-gray-200 rounded-xl transition-all duration-[0.4s] hover:shadow-[0_20px_50px_rgba(148,68,251,0.2)] hover:-translate-y-2 p-6 bg-linear-to-r from-purple-600 to-purple-500 text-white relative'>
                    ...
                    <h5 className='flex items-center text-5xl font-extrabold'><FaDollarSign size={40} />29 <span className='text-lg'>/month</span></h5>
                    <ul>
                ...
                <div className='flex flex-col items-start gap-4 border-2 border-gray-200 rounded-xl transition-all duration-[0.4s] hover:shadow-[0_20px_50px_rgba(148,68,251,0.2)] hover:-translate-y-2 p-6 relative'>
                    ...
                    <h5 className='flex items-center text-5xl font-extrabold'><FaDollarSign size={40} />99 <span className='text-lg'>/month</span></h5>
                    <ul>
